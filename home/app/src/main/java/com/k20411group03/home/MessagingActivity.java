...
import com.k20411group03.AESUtils;
import com.k20411group03.FcmNotificationsSender;
import com.k20411group03.adapters.messageAdapter;
import com.k20411group03.home.databinding.ActivityMessagingBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityMessagingBinding.backBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               Intent intent = new Intent(MessagingActivity.this, manhinhchinhchat.class);

...
import com.k20411group03.home.databinding.FragmentProfileBinding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding.newPic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                activity.setAspectRatio(3, 3);
                activity.setGuidelines(CropImageView.Guidelines.ON);
                activity.setFixAspectRatio(true);
                activity.setOutputCompressQuality(60);
                //check cai nay
               // activity.start(getContext(), ProfileFragment.this);
